...
Ejecutar en M4:
  cd /path/to/medexpert-oncologia
  /path/to/mlx-env/bin/python 05_evaluate_model.py
...
PROJECT_DIR = Path("/path/to/medexpert-oncologia")
MLX_BIN = "/path/to/mlx-env/bin/python"
