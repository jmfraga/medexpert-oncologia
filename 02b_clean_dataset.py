...
Usage:
  /path/to/mlx-env/bin/python 02b_clean_dataset.py
  /path/to/mlx-env/bin/python 02b_clean_dataset.py --dry-run
  /path/to/mlx-env/bin/python 02b_clean_dataset.py --skip-llm-filter
  /path/to/mlx-env/bin/python 02b_clean_dataset.py --input-dir data/ --output-dir data/clean/
